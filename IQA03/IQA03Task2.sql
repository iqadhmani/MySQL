...
VALUES
(DEFAULT, 4, 'dgx_640', 'Yamaha DGX 640 Digital Piano', 'This is the Yamaha DGX 640 Digital Piano with 88 keys.', 845.95, 10, NOW());
...
VALUES
('iqadhmani8823@conestogac.on.ca', '', 'Ibrahim', 'Qadhmani');
...
SET
	password = 's3cr3t'
WHERE
	email_address = 'iqadhmani8823@conestogac.on.ca';
